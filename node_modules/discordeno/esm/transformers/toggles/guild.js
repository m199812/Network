...
export class GuildToggles extends ToggleBitfieldBigint {
    constructor(guild) {
        ...
        if (guild.features.includes(GuildFeatures.ThreeDayThreadArchive))
            this.add(GuildToggle.threeDayThreadArchive);
        if (guild.features.includes(GuildFeatures.SevenDayThreadArchive))
            this.add(GuildToggle.sevenDayThreadArchive);
