...
export async function resharder(oldGateway, results) {
...
export async function resharderIsPending(gateway, oldGateway) {
...
export async function resharderCloseOldShards(oldGateway) {
...
export async function startReshardingChecks(gateway) {
    ...
    }).then((res) => res.json()).then((res) => transformGatewayBot(res)));
...
export async function markNewGuildShardId(guildIds, shardId) {
