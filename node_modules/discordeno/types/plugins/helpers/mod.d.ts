...
import { ApplicationCommandOptionChoice, Bot, Channel, Collection, CreateMessage, FinalHelpers, ListGuildMembers, Member, Message } from "./deps.js";
...
export declare function enableHelpersPlugin(rawBot: Bot): BotWithHelpersPlugin;
