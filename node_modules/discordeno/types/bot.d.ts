...
import { createGatewayManager, GatewayManager } from "./gateway/mod.js";
import { validateLength } from "./util/validateLength.js";
import { delay, formatImageURL, hasProperty } from "./util/utils.js";
...
import { DiscordApplicationCommandOptionChoice, DiscordEmoji, DiscordGatewayPayload, DiscordInteractionDataOption, DiscordReady, DiscordStickerPack, DiscordTemplate } from "./types/discord.js";
import { Errors, GatewayDispatchEventNames, GatewayIntents } from "./types/shared.js";
import { DiscordActivity, DiscordApplication, DiscordApplicationCommand, DiscordApplicationCommandOption, DiscordAttachment, DiscordAuditLogEntry, DiscordChannel, DiscordComponent, DiscordEmbed, DiscordGetGatewayBot, DiscordGuild, DiscordGuildApplicationCommandPermissions, DiscordGuildWidget, DiscordIntegrationCreateUpdate, DiscordInteraction, DiscordInviteCreate, DiscordMember, DiscordMessage, DiscordPresenceUpdate, DiscordRole, DiscordScheduledEvent, DiscordStageInstance, DiscordSticker, DiscordTeam, DiscordThreadMember, DiscordUser, DiscordVoiceRegion, DiscordVoiceState, DiscordWebhook, DiscordWelcomeScreen } from "./types/discord.js";
...
export declare const defaultHelpers: {
    ...
    getArchivedThreads(bot: Bot, channelId: bigint, options?: (helpers.ListPublicArchivedThreads & {
    ...
    getChannel(bot: Bot, channelId: bigint): Promise<Channel>;
    ...
    updateStageInstance(bot: Bot, channelId: bigint, data: import("./types/shared.js").AtLeastOne<Pick<DiscordStageInstance, "topic">, {
    ...
    getDiscoveryCategories(bot: Bot): Promise<Collection<number, import("./types/discord.js").DiscordDiscoveryCategory>>;
    ...
    createEmoji(bot: Bot, guildId: bigint, options: helpers.CreateGuildEmoji): Promise<{
        id: bigint;
    ...
    editWidget(bot: Bot, guildId: bigint, enabled: boolean, channelId?: string | null | undefined): Promise<GuildWidget>;
    ...
    getBans(bot: Bot, guildId: bigint): Promise<Collection<bigint, {
    ...
    getWidgetSettings(bot: Bot, guildId: bigint): Promise<GuildWidget>;
    ...
    batchEditApplicationCommandPermissions(bot: Bot, guildId: bigint, options: {
        id: string;
        permissions: helpers.ApplicationCommandPermissions[];
    ...
    isContextApplicationCommand(cmd: helpers.CreateApplicationCommand | helpers.CreateContextApplicationCommand): cmd is helpers.CreateContextApplicationCommand;
    ...
    editApplicationCommandPermissions(bot: Bot, guildId: bigint, commandId: bigint, options: helpers.ApplicationCommandPermissions[]): Promise<ApplicationCommandPermission>;
    ...
    upsertApplicationCommand(bot: Bot, commandId: bigint, options: helpers.CreateApplicationCommand | helpers.CreateContextApplicationCommand, guildId?: bigint | undefined): Promise<ApplicationCommand>;
    upsertApplicationCommands(bot: Bot, options: (helpers.CreateApplicationCommand | helpers.CreateContextApplicationCommand)[], guildId?: bigint | undefined): Promise<Collection<bigint, ApplicationCommand>>;
    ...
    fetchMembers(bot: Bot, guildId: bigint, shardId: number, options?: Omit<helpers.RequestGuildMembers, "guildId"> | undefined): Promise<void>;
    getDmChannel(bot: Bot, userId: bigint): Promise<Channel>;
    getMember(bot: Bot, guildId: bigint, id: bigint): Promise<Member>;
    ...
    getMessage(bot: Bot, channelId: bigint, id: bigint): Promise<Message>;
    getMessages(bot: Bot, channelId: bigint, options?: helpers.GetMessagesOptions | undefined): Promise<Message[]>;
    ...
    editBotStatus(bot: Bot, data: helpers.StatusUpdate): void;
    getGatewayBot(bot: Bot): Promise<GetGatewayBot>;
    getUser(bot: Bot, userId: bigint): Promise<User>;
    ...
    connectToVoiceChannel(bot: Bot, guildId: bigint, channelId: bigint, options?: import("./types/shared.js").AtLeastOne<Omit<helpers.UpdateVoiceState, "guildId" | "channelId">, {
    ...
    getWebhook(bot: Bot, webhookId: bigint): Promise<Webhook>;
...
export interface EventHandlers {
    ...
    guildMemberAdd: (bot: Bot, member: Member, user: User) => any;
    guildMemberRemove: (bot: Bot, user: User, guildId: bigint) => any;
    guildMemberUpdate: (bot: Bot, member: Member, user: User) => any;
    ...
    messageUpdate: (bot: Bot, message: Message, oldMessage?: Message) => any;
    ...
    presenceUpdate: (bot: Bot, presence: PresenceUpdate, oldPresence?: PresenceUpdate) => any;
    ...
    dispatchRequirements: (bot: Bot, data: DiscordGatewayPayload, shardId: number) => any;
...
export declare function createBotConstants(): {
    ...
    CDN_URL: string;
    endpoints: {
        GUILDS_BASE: (guildId: bigint) => string;
        CHANNEL_BASE: (channelId: bigint) => string;
        GATEWAY_BOT: () => string;
        CHANNEL_MESSAGE: (channelId: bigint, messageId: bigint) => string;
        CHANNEL_MESSAGES: (channelId: bigint) => string;
        ...
        CHANNEL_MESSAGE_REACTION: (channelId: bigint, messageId: bigint, emoji: string) => string;
        ...
        THREAD_ARCHIVED_BASE: (channelId: bigint) => string;
        THREAD_ARCHIVED_PUBLIC: (channelId: bigint) => string;
        THREAD_ARCHIVED_PRIVATE: (channelId: bigint) => string;
        THREAD_ARCHIVED_PRIVATE_JOINED: (channelId: bigint) => string;
        GUILDS: () => string;
        GUILD_AUDIT_LOGS: (guildId: bigint) => string;
        GUILD_BAN: (guildId: bigint, userId: bigint) => string;
        GUILD_BANS: (guildId: bigint) => string;
        ...
        GUILD_MEMBERS: (guildId: bigint) => string;
        GUILD_MEMBER_ROLE: (guildId: bigint, memberId: bigint, roleId: bigint) => string;
        GUILD_MEMBERS_SEARCH: (guildId: bigint) => string;
        GUILD_PRUNE: (guildId: bigint) => string;
        ...
        GUILD_SCHEDULED_EVENTS: (guildId: bigint) => string;
        GUILD_SCHEDULED_EVENT: (guildId: bigint, eventId: bigint) => string;
        GUILD_SCHEDULED_EVENT_USERS: (guildId: bigint, eventId: bigint) => string;
        VOICE_REGIONS: () => string;
        INVITE: (inviteCode: string) => string;
        WEBHOOK: (webhookId: bigint, token: string) => string;
        WEBHOOK_ID: (webhookId: bigint) => string;
        WEBHOOK_MESSAGE: (webhookId: bigint, token: string, messageId: bigint) => string;
        WEBHOOK_MESSAGE_ORIGINAL: (webhookId: bigint, token: string) => string;
        ...
        COMMANDS_ID: (applicationId: bigint, commandId: bigint) => string;
        COMMANDS_GUILD_ID: (applicationId: bigint, guildId: bigint, commandId: bigint) => string;
