 ...
 */
export declare function upsertApplicationCommands(bot: Bot, options: (CreateApplicationCommand | CreateContextApplicationCommand)[], guildId?: bigint): Promise<Collection<bigint, import("../../../mod.js").ApplicationCommand>>;
