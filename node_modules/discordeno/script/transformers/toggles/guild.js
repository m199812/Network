...
class GuildToggles extends ToggleBitfield_js_1.ToggleBitfieldBigint {
    constructor(guild) {
        ...
        if (guild.features.includes(shared_js_1.GuildFeatures.ThreeDayThreadArchive))
            this.add(exports.GuildToggle.threeDayThreadArchive);
        if (guild.features.includes(shared_js_1.GuildFeatures.SevenDayThreadArchive))
            this.add(exports.GuildToggle.sevenDayThreadArchive);
