...
const mod_js_3 = require("./gateway/mod.js");
...
function createBot(options) {
    const bot = {
        ...
        intents: options.intents.reduce((bits, next) => (bits |= shared_js_1.GatewayIntents[next]), 0),
    ...
    bot.gateway = (0, mod_js_3.createGatewayManager)({
        token: bot.token,
        intents: bot.intents,
...
function createUtils(options) {
    return {
        ...
        hasProperty: utils_js_1.hasProperty,
...
function createBotConstants() {
    return {
        ...
        endpoints: constants_js_1.endpoints,
        regexes: {
